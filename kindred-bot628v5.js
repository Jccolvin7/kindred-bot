...
import { Client, GatewayIntentBits, REST, Routes, SlashCommandBuilder, EmbedBuilder, AttachmentBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, ModalBuilder, TextInputBuilder, TextInputStyle, StringSelectMenuBuilder } from 'discord.js';
      ...
      if (interaction.customId.startsWith('rate_star_')) {
        ...
        const embed = new EmbedBuilder()
          ...
          .setDescription(
            ...
            (remainingToUnlock > 0
              ? `\n\n🔓 ${remainingToUnlock} more rating${remainingToUnlock === 1 ? '' : 's'} to unlock your taste twin!`
              : '') +
  ...
  try {
    ...
    if (commandName === 'rate') {
      ...
      const embed = new EmbedBuilder()
        ...
        .setTitle('✅ Rating Saved!')
        .setDescription(
          `**${title}** added to your taste profile.` +
          (remainingToUnlock > 0
            ? `\n\n🔓 ${remainingToUnlock} more rating${remainingToUnlock === 1 ? '' : 's'} to unlock your taste twin!`
            : '') +
          streakConfirmationLine(newStreak)
    ...
    if (commandName === 'daily') {
      ...
      const embed = new EmbedBuilder().setColor(PURPLE).setTitle('🎯 Your Daily Taste Challenge');
