...
async function upsertUser(discordId, username) {
  ...
  // A real insert returned a row with return=representation — this is
  // genuinely a brand new account, not an existing one being upserted
  // over. Caller uses this to log signup_completed exactly once.
